                ...
                <div class=" gap-3 mb-5">
                    <div>
                        <input type="text" id="keyword" name="keyword"
                            class="shadow-sm bg-gray-50 border w-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="Suche" />
                        ...
                        <tbody>
                            @foreach ($leads as $item)
                                <tr class="text-center bg-white border-b dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <td class="px-6 py-4"
                                        style="color:{{ $item->quality_status == 'confirmed' ? 'green' : 'orange' }}">
                                    ...
                                    <td class="px-6 py-4 flex justify-center">
                                        <a href="{{ route('confirmationleads.edit', ['confirmationlead' => $item->id]) }}"><svg
