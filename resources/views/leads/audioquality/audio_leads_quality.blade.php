    ...
    <div class="p-12 sm:ml-64">
        <div class=" space-y-6">
            <div class="bg-white sm:rounded-lg">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg bckdoi">
                        ...
                        <tbody>
                            @foreach ($leads as $item)
                                <tr class="text-center bg-white border-b dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <td class="px-6 py-4"
                                        style="color:{{ $item->audio != null ? 'green' : 'red' }};font-weight:bold">
                                        {{ $item->audio != null ? 'Audio is uploaded' : 'No audio' }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $item->updated_at }}
                                    </td>
                                    ...
                                    <td class="py-4 flex justify-center">
                                        <a href="{{ route('audios.edit', ['audio' => $item->id]) }}"><svg
